...
public class InMemoryApi implements Api {
    ...
    public Response doRequest(Request request) {
        ...
        if (request.getAction().equals("battles") && request.getMethod().equals("GET") && request.getSessionToken().equals("172bc83648184fe9b296321cd1184900")) {
            return new Response(
                    "{\"turn_account_id\": \"562c9347309dc5000aea0301\", \"attacker_id\": \"560affde3492eb00087355f9\", \"defender_id\": \"561439f48d5e0e000c8e7f42\", \"opponent_battlefield\": {\"id\": \"56143bec8d5e0e000c8e7f46\", \"ready_for_battle\": false, \"account_id\": \"560affde3492eb00087355f9\", \"battle_id\": \"560affee3492eb00087355fb\", \"shots\": [{\"x\": 3, \"y\": 2}]}, \"my_battlefield\": {\"account_id\": \"561439f48d5e0e000c8e7f42\", \"ships\": [{\"x\": 5, \"id\": \"is:1\", \"y\": 5}], \"id\": \"56143bec8d5e0e000c8e7f47\", \"ready_for_battle\": false, \"inventory\": {\"is:0\": 1, \"is:1\": 0}, \"battle_id\": \"560affee3492eb00087355fb\", \"shots\": [{\"x\": 3, \"y\": 2}]}, \"id\": \"560affee3492eb00087355fb\", \"state\": 2}",
                    "172bc83648184fe9b296321cd1184900",
                    true
            );
        }
        ...
        if (request.getAction().equals("battle/my-battlefield") && request.getMethod().equals("PUT") && request.getSessionToken().equals("172bc83648184fe9b296321cd1184900") && request.getBody().equals("{\"ships\":[{\"id\":\"is:1\",\"x\":3,\"y\":4}]}")) {
            return new Response(
